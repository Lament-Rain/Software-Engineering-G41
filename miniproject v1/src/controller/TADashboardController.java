...
public class TADashboardController {
    ...
    public void handleMyApplicationsClick(MouseEvent event) {
        ...
        if (applications.isEmpty()) {
            ...
            alert.setContentText("No application records!");
            alert.initModality(Modality.APPLICATION_MODAL);
            alert.showAndWait();
            return;
        }
        ...
        StringBuilder applicationList = new StringBuilder("=== My Applications ===\n\n");
        for (Application app : applications) {
            Job job = JobService.getJobById(app.getJobId());
            if (job != null) {
                applicationList.append("Position: " + job.getTitle() + "\n");
                applicationList.append("Status: " + app.getStatus() + "\n");
                applicationList.append("Application Time: " + app.getCreatedAt() + "\n");
                applicationList.append("Match Score: " + app.getMatchScore() + "\n\n");
            }
        }
        
        Alert alert = new Alert(AlertType.INFORMATION);
        alert.setTitle("My Applications");
        alert.setHeaderText("Application Records");
        alert.setContentText(applicationList.toString());
        alert.initModality(Modality.APPLICATION_MODAL);
        alert.showAndWait();
    }
