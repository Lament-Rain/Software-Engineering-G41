            ...
            case TA:
                ...
                if (currentUser instanceof TA) {
                    ...
                    boolean alreadyApplied = applications.stream()
                            .anyMatch(app -> app.getJobId().equals(currentJob.getId()));
                    if (alreadyApplied) {
                    ...
                    if (currentJob.getDeadline() != null && currentJob.getDeadline().compareTo(now) < 0) {
        ...
        confirmAlert.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                ...
                if (application != null) {
                    ...
                    showAlert("申请失败", "申请提交失败，您可能已经申请过该职位", Alert.AlertType.ERROR);
                }
            }
        });
    }
